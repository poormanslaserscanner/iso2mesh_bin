...
cmake -A x64 -T v141  -DCMAKE_INSTALL_PREFIX:PATH="%PMLS_DIR%/cgalmesh"^
 ...
 -DWITH_tests:BOOL="0"^
 ..\..\iso2mesh_bin\cgalmesh

REM cmake-gui .
REM exit

devenv /build "Release|x64" /project ALL_BUILD Mesh_3_Examples.sln
