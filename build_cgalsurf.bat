...
cmake -A x64 -T v141  -DCMAKE_INSTALL_PREFIX:PATH="%PMLS_DIR%/cgalsurf"^
 ...
 -DWITH_tests:BOOL="0"^
 ..\..\iso2mesh_bin\cgalsurf

REM cmake-gui .
REM exit

devenv /build "Release|x64" /project ALL_BUILD Surface_mesher_Examples.sln
